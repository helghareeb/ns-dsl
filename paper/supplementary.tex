...
\texttt{latency\_measured.csv}, \texttt{latency\_docker.csv}, \texttt{wan\_latency.csv} & Figs.~\ref{fig:latency},~\ref{fig:wan} (measured latency) \\
...
archived under restricted access in Zenodo (data DOI: 10.5281/zenodo.XXXXXXX; software DOI:
10.5281/zenodo.YYYYYYY); see the Data and Code availability statements.
