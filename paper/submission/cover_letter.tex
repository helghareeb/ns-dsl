...
no competing interests and received no specific funding for this work. The supporting data and source
code are openly available---in the Zenodo record DOI 10.5281/zenodo.20932989 and the public repository
https://github.com/helghareeb/ns-dsl, under the CC~BY~4.0 and MIT licences respectively---and the
Data Availability statement in the manuscript and the submission system has been updated accordingly.
