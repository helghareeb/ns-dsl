...
from nsdsl.consensus.strategy import GRADED_STRATEGIES, SCORE_PANEL_STRATEGIES  # noqa: E402
...
ALL_HOPS = {"neutro-waa", "neutro-wga", "lww-crdt", "freshness-slo", "prob-gate",
